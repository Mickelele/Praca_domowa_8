...
namespace Exercise6
{
    public static class LinqTasks
    {
        ...
        public static IEnumerable<object> Task6()
        {
            IEnumerable<object> result = Emps
                .Join(Depts, d => d.Deptno, e => e.Deptno, (emp, dept) => new
                {
                    emp.Ename,
                    emp.Job,
                    dept.Dname
        ...
        public static IEnumerable<object> Task10()
        {
            IEnumerable<object> result = Emps
                ...
                .Union(new[] { new { Ename = "Brak wartości", Job = string.Empty,
        ...
        public static IEnumerable<object> Task11()
        {
            IEnumerable<object> result = Depts.GroupJoin(Emps,
                    Dept => Dept.Deptno,
                    Emp => Emp.Deptno,
                    (Dept, EmpsInDname) => new {
                        name = Dept.Dname,
                        numOfEmployees = EmpsInDname.Count()})
                .Where(anonRec => anonRec.numOfEmployees > 1);
            return result;
        }
        ...
        public static IEnumerable<Emp> Task12()
        {
            IEnumerable<Emp> result = (from Emp in Emps
                    where Emp.metoda() == true                
                    select Emp).OrderBy(Emp => Emp.Ename).
        ...
        public static IEnumerable<Dept> Task14()
        {
            IEnumerable<Dept> result = Depts
                .Where(Dept => {
                    int empCount = (from Emp in Emps 
                        where Emp.Deptno == Dept.Deptno select 1).Count();
    ...
    {
        public static bool metoda(this Emp emp)
        {
            foreach (Emp emp1 in LinqTasks.Emps) {
                if (emp1.Mgr == emp)
                    return true;
            }
            return false;  
